...
def test_project_run_fail_fast(monkeypatch: object, tmp_path: Path) -> None:
    ...
    (spec_dir / "spec_99_invalid.json").write_text(
        Path("tests/fixtures/exp_specs/spec_99_invalid_kind.json").read_text(encoding="utf-8"),
        encoding="utf-8",
    )
