...
BASELINE_DIFF_VERSION = "v1"
BASELINE_DIFF_MANIFEST_VERSION = "v1"
INSTABILITY_MORE_UNSTABLE_DELTA_THRESHOLD = 5.0
INSTABILITY_LESS_UNSTABLE_DELTA_THRESHOLD = -5.0

DRIFT_REPORT_VERSION = "v1"
DRIFT_MANIFEST_VERSION = "v1"
DRIFT_STATUS_MEAN_DELTA_ABS_THRESHOLD = 5.0
DRIFT_STATUS_JACCARD_THRESHOLD = 0.40

DASHBOARD_VERSION = "v1"
DASHBOARD_MANIFEST_VERSION = "v1"
